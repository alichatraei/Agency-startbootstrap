...
window.onscroll = function () {
  ...
  if (
    ...
    navbarMobile.classList.add("nav-colored");
    navbarMobile.classList.remove("nav-transparent");

  } else {
    myNav.classList.add("nav-transparent");
    myNav.classList.remove("nav-colored");
    navbarMobile.classList.add("nav-transparent");
    navbarMobile.classList.remove("nav-colored");
  }
};
